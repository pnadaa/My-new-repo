...
do
    ...
    echo "("$x")" $(head -1 /srv/scratch/z5312523/gsalign/GSAlign/reference_genomes/$x.fna) | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
    head -2 /srv/scratch/z5312523/gsalign/GSAlign/saureus/IS_"$y"/$x/output.maf | tail -n 1 | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
    echo "" | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
    x=$(( $x + 1 ))
done

echo "full details:" | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
...
do
    ...
    echo "" | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
    echo "("$x")" $(head -1 /srv/scratch/z5312523/gsalign/GSAlign/reference_genomes/$x.fna) | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
    head -n 4 /srv/scratch/z5312523/gsalign/GSAlign/saureus/IS_"$y"/$x/output.maf | tail -n 3 | column -t | cat >> /srv/scratch/z5312523/gsalign/GSAlign/saureus/CJ_IS_"$y"_collated.txt
    x=$(( $x + 1 ))
done
